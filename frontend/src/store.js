...
const initialState = {
  userSignin: {
    userInfo: localStorage.getItem("userInfo") // info User
  ...
  cart: {
    cartItems: localStorage.getItem("cartItems")  // Les articles
      ...
      : [],
    shippingAddress: localStorage.getItem("shippingAddress") // L'addresse
      ? JSON.parse(localStorage.getItem("shippingAddress"))
      : {},
      paymentMethod: 'Paypal'  // Méthode de paiement par défaut
  },
};
const reducer = combineReducers({
  ...
  productNewList : productNewListReducer, // BY STEVE
